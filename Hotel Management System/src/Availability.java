...
public class Availability extends javax.swing.JFrame {
    ...
    public Availability() {
        ...
        try
        {
         ...
         Datechoserpanel.setDate(Calendar.getInstance().getTime());
        }
        catch(Exception e)
        {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 260, 110, -1));
        ...
        jPanel1.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 180, 75, -1));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 290, 110, -1));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 230, 110, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/top-aboutus.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        jPanel1.add(jDateChooser2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 180, -1, -1));
        jPanel1.add(jDateChooser3, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 180, -1, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        dt1=Datechoserpanel.getDate();
        dt2=Datechoserpanel.getDate();
        String strdtver1=(String) sdf.format(Datechoserpanel.getDate());
        String strdtver2=(String) sdf.format(Datechoserpanel.getDate());
        long diff=((dt2.getTime()-dt1.getTime()+ONE_HOUR)/(ONE_HOUR*24));
        diffday=Long.toString(diff);
        jTextField4.setText(diffday+"  day(s)");
        String sql="SELECT bookid, roomno, room_type,bedtype, tariffperroom FROM bookingtable"
                + "where roomno NOT INT (SELECT roomno FROM bookingtable WHERE DATE(date_to) >= '" 
                + strdtver1 + "' AND DATE(date_fro) <= '" + strdtver2 + "');";
                
                
               sql= "SELECT roomdetail.room_no, room_type, room_bed, room_rate "
