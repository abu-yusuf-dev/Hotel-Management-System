...
String dt1,dt2;
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), "Customer Info", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Buxton Sketch", 1, 16), new java.awt.Color(223, 223, 255))); // NOI18N
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 510, 270));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
       try{
        ...
        String bidsql="select bookid from bookingtable;";
        ...
        try
        {
            ...
            int code=JOptionPane.showConfirmDialog(this,"Room No. " + roomno + " is booked for Mr./Ms. " + cname + " for "
                ...
                if(code==JOptionPane.YES_NO_OPTION)
                {
                 ...
                 String insqlbook="insert into bookingtable (bookid,roomno,date_fro,date_to,no_of_day) values( '"
